...
export const translations = {
  en: {
    ...
    api_models_endpoint: "Models Endpoint",
    api_gen_endpoint: "Image Generation Endpoint",
    api_env_setup: "Environment Variables",
    api_env_desc: "Configure the following environment variables in Vercel Dashboard → Settings → Environment Variables to enable API access.",
    api_env_apikeys_desc: "API keys for external clients (comma-separated)",
    api_example: "Example",
    api_available_models: "Available Models",
    api_providers: "Providers",
    api_cherry_studio: "Cherry Studio Integration",
    api_cherry_step1: "Go to Settings → Model Providers → Add Provider, select OpenAI compatible.",
    api_cherry_step2: "Set Base URL to:",
    api_cherry_step3: "Enter your API Key (the one set in API_KEYS env var).",
    api_cherry_step4: "Go to Painting, select this provider, then choose a model to generate images.",
    api_newapi: "New API Integration",
    api_newapi_step1: "Go to Channels → Create Channel, select 'OpenAI' type.",
    api_newapi_step2: "Set Base URL to:",
    api_newapi_step3: "Enter the API Key (the one set in API_KEYS env var).",
    api_newapi_step4: "Add models (e.g. z-image-turbo, imagen-4) and enable the channel.",
    api_curl_example: "cURL Example",
    api_open_vercel: "Open Vercel Dashboard",
  ...
  zh: {
    ...
    tab_api: "API",
    api_endpoint: "API 端点",
    api_models_endpoint: "模型列表端点",
    api_gen_endpoint: "图片生成端点",
    api_env_setup: "环境变量配置",
    api_env_desc: "在 Vercel Dashboard → Settings → Environment Variables 中配置以下环境变量以启用 API 访问。",
    api_env_apikeys_desc: "外部客户端使用的 API Key（多个用逗号分隔）",
    api_example: "示例",
    api_available_models: "可用模型",
    api_providers: "支持的服务商",
    api_cherry_studio: "Cherry Studio 接入",
    api_cherry_step1: "进入设置 → 模型服务商 → 添加服务商，选择 OpenAI 兼容类型。",
    api_cherry_step2: "设置 Base URL 为：",
    api_cherry_step3: "输入 API Key（即 API_KEYS 环境变量中设置的值）。",
    api_cherry_step4: "进入绘图功能，选择该服务商，然后选择模型即可生成图片。",
    api_newapi: "New API 接入",
    api_newapi_step1: "进入渠道管理 → 新建渠道，类型选择 'OpenAI'。",
    api_newapi_step2: "设置代理地址为：",
    api_newapi_step3: "输入密钥（即 API_KEYS 环境变量中设置的值）。",
    api_newapi_step4: "添加模型（如 z-image-turbo、imagen-4），启用渠道即可。",
    api_curl_example: "cURL 示例",
    api_open_vercel: "打开 Vercel 控制台",
